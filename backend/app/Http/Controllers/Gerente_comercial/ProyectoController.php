...
class ProyectoController extends Controller
{
    ...
    public function mostrarDatos()
    {
        ...
        return view('gerente_comercial.proyecto', compact('gerente_comercial', 'proyecto','categorias_proyectos'));
    }
    ...
    public function agregarProyecto(Request $request)
    {
        ...
        $gerente_comercial = Gerente_comercial::find(session('id_gerente_comercial'));
        $idDuenio = $gerente_comercial->duenio_id;
        ...
        Proyecto::create([
            ...
            'duenio_id' => $idDuenio,
            'gerente_comercial_id' => $gerente_comercial->id,
    ...
    {
        // Obtener el ID del gerente comercial autenticado
        $id_gerente_comercial = Auth::id();
        $categorias_proyectos = Categoria_proyecto::all();
        return view('gerente_comercial.agregar_proyecto', compact('categorias_proyectos', 'id_gerente_comercial'));
    }
