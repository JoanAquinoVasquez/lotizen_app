    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
            ...
            <div style="flex: 1; padding-right: 20px;">
                ...
                <!-- Ejemplo: -->
                <form method="POST" action="{{ route('gerente_comercial_agregarProyecto') }}">
                    @csrf
                ...
                <ul id="listaProyectos">
                    @foreach($gerente_comercial->proyectos as $proyecto)
                        <li>
                            <a href="#" class="proyecto-link" data-proyecto-id="{{ $proyecto->id }}">{{ $proyecto->nombre }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div style="flex: 2;">
                ...
                @if(isset($proyecto))
                <form method="POST" action="{{ route('gerente_comercial_guardar_Proyecto', ['id' => $proyecto->id]) }}">
                    @csrf
