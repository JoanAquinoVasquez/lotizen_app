        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
            ...
            <div style="flex: 1; padding-right: 20px;">
                ...
                <!-- Ejemplo: -->
                    ...
                    <a href="<?php echo e(route('duenio_mostrarFormProyecto')); ?>">Agregar Proyecto</a>
            ...
            <div style="flex: 2;">
                ...
                <form method="POST" action="<?php echo e(route('duenio_guardar_Proyecto')); ?>">
                    <?php echo csrf_field(); ?>
                    <!-- Campos para editar detalles del proyecto -->
                        ...
                        <input type="date" name="fecha_inicio_proyecto" value="<?php echo e($proyecto->fecha_inicio); ?>"><!-- ... Otros campos para editar detalles del proyecto ... -->
                ...
                <form method="POST" action="<?php echo e(route('duenio_eliminarProyecto', ['id' => $proyecto->id])); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?> <!-- Asegúrate de agregar el método DELETE -->
...
<?php /**PATH C:\xampp\htdocs\lotizen\backend\resources\views/duenio/proyecto.blade.php ENDPATH**/ ?>