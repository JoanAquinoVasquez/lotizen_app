...
<body>
    ...
    <div class="main-content">
        ...
        <form method="POST" action="<?php echo e(route('duenio_guardar_datos')); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Proyecto_Inmobiliaria\Proyecto_inmobiliaria\resources\views/duenio/miperfil.blade.php ENDPATH**/ ?>