    ...
    <div class="main-content">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
            ...
            <div style="flex: 2;">
                ...
                <form method="POST" action="<?php echo e(route('gerente_comercial_guardar_Proyecto', ['id' => $proyecto->id])); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Proyecto_Inmobiliaria\Proyecto_inmobiliaria\resources\views/gerente_comercial/proyecto.blade.php ENDPATH**/ ?>