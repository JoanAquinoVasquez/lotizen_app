...
function IconBxsBuildingHouse(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export { IconPlusCircle, IconProject, IconBxsBuildingHouse, IconPeopleFill, IconPersonFill, IconGoal};